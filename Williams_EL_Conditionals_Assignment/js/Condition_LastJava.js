...
alert("Whoops, Please refresh the page and start again, Your cost will not be correct if you continue");//user error message to restart
...
if  (typeOfRoom === ""){
    ...
    (typeOfRoom < "50"){
    typeOfRoom = prompt ("Only a value of 50 or 100 can be entered");
    console.log ("Only a value of 50 or 100 can be entered")
}else if
    (typeOfRoom === "1000"){
    typeOfRoom = prompt ("Only a value of 50 or 100 can be entered");
    console.log ("Only a value of 50 or 100 can be entered")
